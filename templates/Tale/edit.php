...
<div class="row form-group">
    ...
    <div class="col-sm-9">
        <?php echo $this->Form->control('tale_introduce', ['type' => 'textarea', 'name' => 'tale_introduce', 'class' => 'form-control', 'rows' => 11, 'label' => 'Giới Thiệu']); ?>
    </div>
</div>
<div class="form-group">
    <?= $this->Form->button(__('Sửa Truyện'), ["class" => "btn btn-success"]) ?>
    <?= $this->Form->end() ?>
</div>